...
use App\Http\Controllers\Web\Core\DatabaseController;
        ...
        'configure-environments' => [
            ...
            'fields' => [
                ...
                'app_protocol' => [
                    ...
                    'field_label' => 'App Protocol',
                    'validation' => 'required|in:http,https'
                ],
                'app_url' => [
                    'field_type' => 'text',
                    'field_label' => 'App URL',
        ...
        'superadmin' => [
            ...
            'fields' => [
                'first_name' => [
                    ...
                    'validation' => 'required|alpha_dash|max:50'
                ],
                'last_name' => [
                    'field_type' => 'text',
                ...
                'password' => [
                    'field_type' => 'text',
                    'field_label' => 'Password',
                    'validation' => 'required|min:6|max:32'
                ],
