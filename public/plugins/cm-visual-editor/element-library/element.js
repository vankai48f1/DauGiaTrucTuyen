...
cmbAllElements['cmb_dynamic_element']= {
...
cmbAllElements['cmb_default_title'] = {
    ...
    html: `<div class="cmb-margin-bottom cmb-default-title-wrapper cmb_default_title cmb-element">
            <h2 class="cmb-title"><span class="cmb-single-line-editable-text">Default Title</span></h2>
        </div>`,
};
...
cmbAllElements['cmb_testimonial_item'] = {
            ...
            options: [
                {
                    'style' : {
                        ...
                        inputType : 'select',
                        attribute : 'custom-class',
                        fieldParam : cmbStyleTypes['testimonialStyle']
                    },
                    'client-avatar' : {
                        title: 'Client Avatar',
                        subTitle : 'Specifies the path to the image',
                        ...
                        inputType: 'image',
                        tagProp: 'src',
                        childItem: '.cmb-client-avatar img',
                    },
                    'alt' : {
    ...
    html: `<div class="cmb_testimonial_item cmb-element">
            ...
            options: [
                {
                    ...
                    'person-designation-color' : {
                        title: 'Person Designation Text Color',
                        subTitle: 'Text color control for the person designation text.',
                        type: 'input',
                        inputType: 'colorPicker',
                        attribute : 'style',
                        styleName : 'color',
                        childItem: '.cmb-person-designation'
                    },
                    'person-avatar' : {
                    ...
                    'profile-btn-text-color' : {
                        title: 'Profile Button Text Color',
                        subTitle: 'Control profile button text color.',
                        type: 'input',
                        inputType: 'colorPicker',
                        childItem: '.cmb-person-profile-button',
                        attribute : 'style',
                        styleName : 'color',
                    },
                    'profile-btn-bg' : {
                        title: 'Profile Button Background Color',
                        subTitle: 'Control profile button background color.',
                        type: 'input',
                        inputType: 'colorPicker',
                        childItem: '.cmb-person-profile-button',
                        attribute : 'style',
                    ...
                    'profile-btn-bdr' : {
                        title: 'Profile Button Border Color',
                        subTitle: 'Control profile button border color.',
                        type: 'input',
                        inputType: 'colorPicker',
                        childItem: '.cmb-person-profile-button',
                        attribute : 'style',
                    ...
                    'profile-btn-url' : {
                        title: 'Profile Button Link',
                        subTitle: 'Add profile button link',
                        type: 'input',
                        inputType: 'url',
                        childItem: '.cmb-person-profile-button',
                        attribute : 'prop',
                    ...
                    'profile-btn-size' : {
                        title: 'Profile Button Size',
                        subTitle: 'Control profile button size',
                        type: 'input',
                        childItem: '.cmb-person-profile-button',
                        attribute : 'custom-class',
                        inputType: 'switch',
                    ...
                    'social-link-bar' : {
                        ...
                        attribute : 'custom-class',
                        defaultValue: 'd-none',
                        childItem: '.cmb-person-social-bar',
                    },
                    'person-fb-link' : {
                        title: 'Facebook Link',
                    ...
                    'person-fb-container' : {
                        ...
                        attribute : 'custom-class',
                        defaultValue: 'd-none',
                        childItem: '.cmb-person-fb-container',
                    },
                    'person-tw-link' : {
                        title: 'Twitter Link',
                    ...
                    'person-tw-container' : {
                        ...
                        attribute : 'custom-class',
                        defaultValue: 'd-none',
                        childItem: '.cmb-person-tw-container',
                    },
                    ...
                    'person-yt-container' : {
                        ...
                        attribute : 'custom-class',
                        defaultValue: 'd-none',
                        childItem: '.cmb-person-yt-container',
                    },
                    'person-li-link' : {
                        title: 'Linkedin Link',
                    ...
                    'person-li-container' : {
                        ...
                        attribute : 'custom-class',
                        defaultValue: 'd-none',
                        childItem: '.cmb-person-li-container',
                    },
                    'person-so-link' : {
                    ...
                    'person-so-container' : {
                        ...
                        attribute : 'custom-class',
                        defaultValue: 'd-none',
                        childItem: '.cmb-person-so-container',
                    },
                }
            ]
        },
    },
    html: `<div class="cmb_person_box card cmb-element">
        <img class="card-img-top cmb-person-avatar img-fluid" src="images/avatar.jpg" alt="image">
        <div class="card-body">
            <h4 class="card-title">
                <span class="cmb-single-line-editable-text cmb-person-name">Person Name</span>
                <p class="my-1" style="font-size: 14px">
                    <span class="cmb-single-line-editable-text cmb-person-designation">Designation</span>
                </p>
            </h4>
            <div class="card-text mb-2">
                <div class="cmb-editable-text"><div class="cmb-editable-text-container">Some example text some example text. John Doe is an architect and engineer</div></div>
            </div>

            <div class="row">
                <div class="col-12">
                    <ul class="nav cmb-person-social-bar">
                        <li class="nav-item cmb-person-fb-container">
                            <a class="nav-link cmb-person-fb-link" href="#"><i class="fa fa-facebook cmb-social-media-icon"></i></a>
                        </li>
                        <li class="nav-item cmb-person-tw-container">
                            <a class="nav-link cmb-person-tw-link" href="#"><i class="fa fa-twitter cmb-social-media-icon"></i></a>
                        </li>
                        <li class="nav-item cmb-person-yt-container">
                            <a class="nav-link cmb-person-yt-link" href="#"><i class="fa fa-youtube cmb-social-media-icon"></i></a>
                        </li>
                        <li class="nav-item cmb-person-li-container">
                            <a class="nav-link cmb-person-li-link" href="#"><i class="fa fa-linkedin cmb-social-media-icon"></i></a>
                        </li>
                        <li class="nav-item cmb-person-so-container">
                ...
                <div class="col-12 mt-2">
                    <a href="#" class="btn btn-primary btn-block cmb-person-profile-button"><span class="cmb-single-line-editable-text">See Profile</span></a>
                </div>
            </div>
        </div>
    </div>`
...
cmbAllElements['cmb_reset_button'] = {
    ...
    avoidableTabs: ['position'],
    settings: {},
    html: `<button type="reset" class="btn btn-danger border-0 cmb_reset_button"><span class="cmb-single-line-editable-text">RESET</span></button>`,
};
