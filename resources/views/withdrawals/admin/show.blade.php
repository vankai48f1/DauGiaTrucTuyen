    ...
    <div class="container py-5">
                        ...
                        <div class="table-responsive">
                            <table class="table table-borderless">
                                <tr>
                                    ...
                                    <td>{{ ($withdrawal->amount - $withdrawal->system_fee) }} {{ $withdrawal->symbol }}</td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span
                                            class="badge badge-{{ get_color_class($withdrawal->status, 'payment_status')}}">
        ...
        <div class="row">
            <div class="col-12 text-right">
                @if(has_permission(replace_current_route_action('update')) && $withdrawal->status === PAYMENT_STATUS_REVIEWING)
                ...
                @endif
                @if(has_permission(replace_current_route_action('destroy')) && in_array($withdrawal->status, [PAYMENT_STATUS_REVIEWING, PAYMENT_STATUS_PENDING]))
