...
@section('content')
    @component('components.auth')
        <h2 class="text-center text-danger font-size-50">403</h2>
        <h4 class="text-center text-danger font-size-18">{{ (isset($exception) && $exception->getMessage()) ? $exception->getMessage() : __('Unauthorized Access!')  }}</h4>
