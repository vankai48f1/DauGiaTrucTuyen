                    ...
                    <div class="nav-tabs-custom">
                        ...
                        <div class="p-4 bg-white border lf-toggle-border-color clearfix">
                            <div class="text-center">
                                ...
                                <p>
                                    <a href="{{ route('kyc.addresses.index') }}"
                                       class="small">{{ __('Change Address') }}</a>
                                </p>
                            </div>
                            @include('kyc.user.address._address_table')
                            <hr>
                            {{ Form::open(['route'=> ['kyc.addresses.verification.store', 'address' => $address->id], 'id'=> 'create-address-verification', 'files' => true ]) }}
                            ...
                            <div id="identification">
                                ...
                                <div>
                                    ...
                                    <div id="id-form-section">
                                        <div
                                            v-if="nextSelect == {{IDENTIFICATION_TYPE_WITH_ADDRESS_BANK_STATEMENT}} || nextSelect == {{IDENTIFICATION_TYPE_WITH_ADDRESS_UTILITY_BILL}} ">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="row">
                                                            ...
                                                            <div class="fileinput fileinput-new"
                                                                ...
                                                                <div class="fileinput fileinput-new"
                                                                    ...
                                                                    <div class="fileinput-new img-thumbnail mb-3">
                                                                        <img class="img"
                                                                             src="{{know_your_customer_images('preview.png')}}"
                                                                             alt="">
                                                                    </div>
                                                                    <div
                                                                        class="fileinput-preview fileinput-exists mb-3 img-thumbnail"></div>
                                                                    <div>
                                                                                <span
                                                                                    class="btn btn-sm btn-outline-success btn-file">
                                                                                    <span
                                                                                        class="fileinput-new">Select</span>
                                                                                    <span class="fileinput-exists">Change</span>
                                                                                    {{ Form::file('front_image', ['front_image','class'=>'multi-input', 'id' => 'front_image'])}}
                                                                                </span>
                                                                        <a href="#"
                                                                           class="btn btn-sm btn-outline-danger fileinput-exists"
                                                        ...
                                                        <div class="col-md-8">
                                                            ...
                                                            <p class="mt-3 mb-0 color-333"> {{__('- Maximum Image Size :')}}
                                                                <span class="font-weight-bold">{{__('2MB')}}</span></p>
                                                            <p class="mt-1 color-333">{{__('- Maximum Image Dimension :')}}
                                                                <span
                                                                    class="font-weight-bold">{{__('1600x1200')}}</span>
                                                            </p>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="mt-5">
                                                <div v-if="nextSelect != ''" class="d-inline-block float-right ml-3">
                                                    <div class="form-group">
                                                        {{ Form::submit(__('Submit'),['class'=>'btn text-center btn-info fz-14 d-inline-block border-0']) }}
                                                    </div>
                                                </div>
                                            </div>
