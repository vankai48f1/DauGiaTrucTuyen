                        ...
                        <div class="property-top mb-3">
                            ...
                            <div class="row">
                                <div class="col-lg-8 col-md-12">
                                    ...
                                    <div class="item-name"><h3
                                            class="color-666 font-weight-bold">{{$auction->title}}</h3></div>
                                    <!-- End: property title -->
                                    ...
                                    <div class="property-overview">
                                        <ul class="nav">
                                            <li class=" ml-0 color-999">
                                                ...
                                                By <a
                                                    href="{{route('seller.store.show', $auction->seller->ref_id)}}">{{ !is_null($auction->seller) ? $auction->seller->name : ''}}</a>
                                            </li>
                                            <li class=" ml-0 color-999">
                        ...
                        <div class="popular-cat">
                            ...
                            <ul class="list-group mt-3">
                                ...
                                <li class="list-group-item d-flex justify-content-between align-items-center">
                                    ...
                                    <span
                                        class="badge badge-primary badge-pill">{{$auction->bids->max('amount')}}</span>
                                </li>
                            </ul>
                    ...
                    <div class="single-blog mt-5">
                        ...
                        <div class="custom-profile-nav">
                            ...
                            <div class="tab-content" id="nav-tabContent">
                                ...
                                <div class="tab-pane fade mt-4 show active" id="descrip" role="tabpanel"
                                                        ...
                                                        @foreach($list['items'] as $bid)
                                                            <tr>
                                                                ...
                                                                <td class="text-left"><span
                                                                        class="font-weight-bold">{{$bid->user->username}}</span>
                                                                </td>
                                                                <td class="text-right"><span
                                                                        class="color-default font-weight-bold fz-16">{{$bid->amount}}</span>
                                                                    <span
...
@section('style-top')
    <link rel="stylesheet" href="{{asset('public/css/auction_view_backend.css')}}">
