<div class="custom-profile-nav">
    <ul class="nav nav-tabs mb-4" id="myTab" role="tablist">
        <li class="nav-item">
            <a class="nav-link px-5 py-2 {{is_current_route(['buyer-attended-auction.index','buyer-winning-auction.index'], 'active')}}" href="{{route('buyer-attended-auction.index')}}">{{__('Profile')}}</a>
        </li>
