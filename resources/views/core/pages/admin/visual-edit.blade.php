...
@section('style')
    ...
    <link href="{{ asset('public/plugins/cm-visual-editor/vendor/colorpicker/jquery.minicolors.css') }}" rel="stylesheet" type="text/css">
    <link href="{{ asset('public/plugins/cm-visual-editor/vendor/tinymce/skins/lightgray/skin.min.css') }}" rel="stylesheet" type="text/css">
    <link href="{{ asset('public/plugins/cm-visual-editor/vendor/tinymce/skins/lightgray/content.min.css') }}" rel="stylesheet" type="text/css">
    ...
    <link href="{{ asset('public/plugins/cm-visual-editor/visual-editor-style.css') }}" rel="stylesheet">
    ...
    <link href="{{ asset('public/plugins/cm-visual-editor/vendor/cmfonts/cmfonts.css') }}" rel="stylesheet">
...
@section('script')
    <script>
        let pageId = '{{ $page->id }}';
        let pageCssPath = '{{ asset("public/uploads/css/cm-visual-builder/style-{$page->id}.css") }}';
        let savePageUrl = '{{ route('admin.pages.visual-edit', $page->id) }}';
        let dynamicContentUrl = '{{ route('admin.dynamic-content') }}';
    </script>
    <script src="{{ asset('public/plugins/cm-visual-editor/visual-editor/visual-editor-initialization.js') }}"></script>
    <script src="{{ asset('public/plugins/cm-visual-editor/vendor/tinymce/tinymce.min.js') }}" type="text/javascript"></script>
    <script src="{{ asset('public/plugins/cm-visual-editor/vendor/tinymce/themes/modern/theme.min.js') }}" type="text/javascript"></script>
    <script src="{{ asset('public/plugins/cm-visual-editor/vendor/tinymce/plugins/code/plugin.min.js') }}" type="text/javascript"></script>
    <script src="{{ asset('public/plugins/cm-visual-editor/vendor/tinymce/plugins/colorpicker/plugin.min.js') }}" type="text/javascript"></script>
    <script src="{{ asset('public/plugins/cm-visual-editor/vendor/tinymce/plugins/hr/plugin.min.js') }}" type="text/javascript"></script>
    <script src="{{ asset('public/plugins/cm-visual-editor/vendor/tinymce/plugins/image/plugin.min.js') }}" type="text/javascript"></script>
    <script src="{{ asset('public/plugins/cm-visual-editor/vendor/tinymce/plugins/link/plugin.min.js') }}" type="text/javascript"></script>
    <script src="{{ asset('public/plugins/cm-visual-editor/vendor/tinymce/plugins/lists/plugin.min.js') }}" type="text/javascript"></script>
    <script src="{{ asset('public/plugins/cm-visual-editor/vendor/tinymce/plugins/paste/plugin.min.js') }}" type="text/javascript"></script>
    <script src="{{ asset('public/plugins/cm-visual-editor/vendor/tinymce/plugins/table/plugin.min.js') }}" type="text/javascript"></script>
    <script src="{{ asset('public/plugins/cm-visual-editor/vendor/tinymce/plugins/textcolor/plugin.min.js') }}" type="text/javascript"></script>
    <script src="{{ asset('public/plugins/cm-visual-editor/vendor/colorpicker/jquery.minicolors.min.js') }}"></script>
    <script src="{{ asset('public/plugins/cm-visual-editor/visual-editor/style-inputs.js') }}"></script>
    <script src="{{ asset('public/plugins/cm-visual-editor/visual-editor/visual-editor-primary-elements.js') }}"></script>
    <script src="{{ asset('public/plugins/cm-visual-editor/element-library/element.js') }}"></script>
    <script src="{{ asset('public/plugins/cm-visual-editor/element-library/auction-element.js') }}"></script>
    <script src="{{ asset('public/plugins/cm-visual-editor/visual-editor/visual-editor-general-settings.js') }}"></script>
    <script src="{{ asset('public/plugins/cm-visual-editor/visual-editor/class-settings.js') }}"></script>
    <script src="{{ asset('public/plugins/cm-visual-editor/visual-editor/input-type.js') }}"></script>
    <script src="{{ asset('public/plugins/cm-visual-editor/visual-editor/visual-editor-functions.js') }}"></script>
    <script src="{{ asset('public/plugins/cm-visual-editor/visual-editor/visual-editor.js') }}"></script>
    <script src="{{ asset('public/plugins/cm-visual-editor/visual-editor/visual-editor-events.js') }}"></script>
    ...
    <script src="{{ asset('public/plugins/cm-visual-editor/slider-builder.js') }}"></script>
