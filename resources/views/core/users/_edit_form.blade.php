...
<div class="form-group row">
    ...
    <div class="col-md-8">
        @if(!$user->is_super_admin && $user->id != Auth::user()->id)
            <div class="lf-select">
            {{ Form::select('assigned_role', $roles, old('assigned_role', $user->assigned_role),['class' => form_validation($errors, 'assigned_role'),'id' => 'assigned_role','placeholder' => __('Select Role')]) }}
            </div>
