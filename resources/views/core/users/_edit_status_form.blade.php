...
<div class="form-group row">
    ...
    <div class="col-md-8">
        <div class="lf-select">
        {{ Form::select('is_email_verified', email_status(), null, ['class' => form_validation($errors, 'is_email_verified'),'id' => 'is_email_verified','placeholder' => __('Select Status')]) }}
        </div>
...
<div class="form-group row">
    ...
    <div class="col-md-8">
        <div class="lf-select">
        {{ Form::select('status', account_status(), null, ['class' => form_validation($errors, 'status'),'id' => 'status','placeholder' => __('Select Status')]) }}
        </div>
...
<div class="form-group row">
    ...
    <div class="col-md-8">
        <div class="lf-select">
        {{ Form::select('is_financial_active', financial_status(), null, ['class' => form_validation($errors, 'is_financial_active'),'id' => 'is_financial_active','placeholder' => __('Select Status')]) }}
        </div>
...
<div class="form-group row">
    ...
    <div class="col-md-8">
        <div class="lf-select">
        {{ Form::select('is_accessible_under_maintenance', maintenance_accessible_status(), null, ['class' => form_validation($errors, 'is_accessible_under_maintenance'),'id' => 'is_accessible_under_maintenance','placeholder' => __('Select Status')]) }}
        </div>
