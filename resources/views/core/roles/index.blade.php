                                    ...
                                    <div class="btn-group">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right" role="menu">
                                            <a class="dropdown-item"
                                               href="{{ route('roles.edit',[$role->slug, 'web']) }}"><i
                                                    class="fa fa-th-list mr-1"></i> {{ __('Web Permission') }}</a>
                                            <a class="dropdown-item"
                                               href="{{ route('roles.edit',[$role->slug, 'api']) }}"><i
                                                    class="fa fa-th-list mr-1"></i> {{ __('API Permission') }}</a>
