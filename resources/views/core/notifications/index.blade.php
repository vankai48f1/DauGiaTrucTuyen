                                ...
                                <td class="lf-action text-right">
                                    <div class="btn-group">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right" role="menu">
                                            @if($notice->link != null)
                                                <a class="dropdown-item" href="{{$notice->link }}"><i
                                                        class="fa fa-dot-circle-o text-red"></i> {{ __('Go to link') }}
                                                </a>
                                            @endif
                                            @if(has_permission('notifications.mark-as-unread') && $notice->read_at)
                                                <a class="dropdown-item"
                                                   href="{{ route('notifications.mark-as-unread',$notice->id) }}"><i
                                                        class="fa fa-dot-circle-o"></i> {{ __('Mark as unread') }}
                                                </a>
                                            @else
                                                <a class="dropdown-item"
                                                   href="{{ route('notifications.mark-as-read',$notice->id) }}"><i
                                                        class="fa fa-dot-circle-o"></i> {{ __('Mark as read') }}
                                                </a>
                                            @endif
                                        </div>
                                    </div>
