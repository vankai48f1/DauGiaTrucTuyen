        ...
        <div class="row">
            <div class="col-md-3">
                <div class="card card-outline card-info lf-toggle-border-color lf-toggle-bg-card mb-4 shadow-sm">
                    <div class="card-header bg-light">
                        <h5 class="color-666">{{ __('Select Nav') }}</h5>
                    </div>
                    <div class="card-body">
                ...
                <div class="card lf-toggle-border-color lf-toggle-bg-card card-outline card-info mb-4 shadow-sm overflow-hidden">
                    <div class="card-header bg-light">
                        <h5 class="color-666">{{ __('Add Routes') }}</h5>
                    </div>
                                    ...
                                    @if(is_array($middleware) && count(array_intersect($middleware,['permission','guest.permission','verification.permission','menuable']))>0)
                                        <div class="checkbox lf-checkbox">
                                            ...
                                            <label for="checkbox-route-{{$routeName}}"
                                                   class="mb-0">{{$routeData->getName()}}</label>
                                        </div>
                                        <?php $count++; ?>
                                    @endif
                                @endforeach
                ...
                <div class="card card-outline card-info mb-4 shadow-sm overflow-hidden">
                    <div class="card-header bg-light">
                        <h5 class="color-666">{{ __('Add Pages') }}</h5>
                    </div>
                    <div class="card-body pb-0">
                        ...
                        <div class="ml-n1">
                            <div id="all-pages"
                                 class="lf-h-150px overflow-auto content-box ml-n2 mr-n4 border-top border-gray"
                                 data-name="Unnamed">
                ...
                <div class="card card-outline card-info shadow-sm">
                    <div class="card-header bg-light">
                        <h5 class="color-666">{{ __('Add LINK') }}</h5>
                    </div>
                    <div class="card-body">
            ...
            <div class="col-md-9">
                <div class="card lf-toggle-border-color lf-toggle-bg-card card-outline card-info">
                    <div class="card-header bg-light">
                        <h5 class="color-666">{{ __('Menu Items') }}</h5>
                    </div>
                    <div class="card-body">
...
@section('style')
    <link rel="stylesheet" href="{{ asset('public/css/menu-builder.css') }}">
@endsection

@section('script')
    <script src="{{asset('public/plugins/jQueryUI/jquery-ui.min.js')}}"></script>
    <script src="{{asset('public/plugins/menu_manager/jquery.mjs.nestedSortable.js')}}"></script>
    <script src="{{asset('public/plugins/menu_manager/adminmenuhandler.js')}}"></script>
@endsection
