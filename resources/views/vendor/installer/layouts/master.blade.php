...
$title = isset( $sections['title'] ) && !empty( $sections['title'] ) ? $sections['title'] : 'Laravel Web Installer';
?>
    <!DOCTYPE html>
<html>
<head>
    ...
    <link rel="icon" type="image/png" href="{{ asset('public/installer/img/favicon.png') }}" sizes="64x64"/>
